...
#define |KK VALUE|                           // constants related with the politropic eos for the
#define |m VALUE|                            // fermion part (KK and polind) and the mass (m) of
#define |fa_axion VALUE|                     // the scalar field and the decay constant (fa) for
#define |polind VALUE|                       // the axion potential
